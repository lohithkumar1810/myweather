...
// node_modules/vanta/dist/vanta.clouds.min.js
var require_vanta_clouds_min = __commonJS({
  "node_modules/vanta/dist/vanta.clouds.min.js"(exports, module) {
    !function(e, t) {
      ...
      s.VantaBase = class {
        constructor(e2 = {}) {
          ...
          const h2 = window.addEventListener;
          h2("resize", this.resize), window.requestAnimationFrame(this.resize), this.options.mouseControls && (h2("scroll", this.windowMouseMoveWrapper), h2("mousemove", this.windowMouseMoveWrapper)), this.options.touchControls && (h2("touchstart", this.windowTouchWrapper), h2("touchmove", this.windowTouchWrapper)), this.options.gyroControls && h2("deviceorientation", this.windowGyroWrapper);
        }
        setOptions(e2 = {}) {
      ...
      class c extends a {
        constructor(e2) {
          h = e2.THREE || h, h.Color.prototype.toVector = function() {
            return new h.Vector3(this.r, this.g, this.b);
          }, super(e2), this.updateUniforms = this.updateUniforms.bind(this);
        }
        init() {
          this.mode = "shader", this.uniforms = { iTime: { type: "f", value: 1 }, iResolution: { type: "v2", value: new h.Vector2(1, 1) }, iDpr: { type: "f", value: window.devicePixelRatio || 1 }, iMouse: { type: "v2", value: new h.Vector2(this.mouseX || 0, this.mouseY || 0) } }, super.init(), this.fragmentShader && this.initBasicShader();
        }
        setOptions(e2) {
        ...
        initBasicShader(e2 = this.fragmentShader, t2 = this.vertexShader) {
          ...
          const i2 = new h.ShaderMaterial({ uniforms: this.uniforms, vertexShader: t2, fragmentShader: e2 }), n2 = this.options.texturePath;
          n2 && (this.uniforms.iTex = { type: "t", value: new h.TextureLoader().load(n2) });
          const o2 = new h.Mesh(new h.PlaneGeometry(2, 2), i2);
          this.scene.add(o2), this.camera = new h.Camera(), this.camera.position.z = 1;
        }
        updateUniforms() {
          const e2 = {};
          let t2, i2;
          for (t2 in this.options) i2 = this.options[t2], -1 !== t2.toLowerCase().indexOf("color") ? e2[t2] = { type: "v3", value: new h.Color(i2).toVector() } : "number" == typeof i2 && (e2[t2] = { type: "f", value: i2 });
